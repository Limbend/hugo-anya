document.addEventListener("DOMContentLoaded", function () {
  ...
  carousels.forEach(function (carousel) {
    ...
    const bullets = carousel.querySelectorAll(".carousel-nav div");
    ...
    if (amountvisible > 1) {
      var removeels = carousel.querySelectorAll(
        ".carousel-nav div:nth-last-child(-n + " + (amountvisible - 1) + ")"
      );
    ...
    const setSelected = function () {
      ...
      carousel
        .querySelector(".carousel-nav div:nth-child(" + nthchild + ")")
    ...
    const nextSlide = function () {
      if (
        !carousel
          .querySelector(".carousel-nav div:last-child")
          .classList.contains("selected")
      ) {
        carousel
          .querySelector(".carousel-nav div.selected")
          .nextElementSibling.querySelector("a")
          .click();
      } else {
        carousel.querySelector(".carousel-nav div:first-child a").click();
      }
    };
    ...
    const prevSlide = function () {
      if (
        !carousel
          .querySelector(".carousel-nav div:first-child")
          .classList.contains("selected")
      ) {
        carousel
          .querySelector(".carousel-nav div.selected")
        ...
        carousel.querySelector(".carousel-nav div:last-child a").click();
      }
    };
